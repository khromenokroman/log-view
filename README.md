...
Приложение позволяет загрузить файл с JSON-логами, сохранить его на сервере и получить уникальную ссылку для повторного
просмотра. Этой ссылкой можно поделиться с другим человеком, чтобы он тоже мог открыть тот же лог без повторной загрузки
файла.

Сервис отображает записи в удобном и читаемом виде: с цветовой подсветкой по уровню важности, форматированием времени,
имени хоста, идентификатора процесса и текста сообщения.
